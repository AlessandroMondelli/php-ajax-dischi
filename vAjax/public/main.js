...
$(document).ready(function () {
  ...
  var Handlebars = __webpack_require__(/*! handlebars */ "./node_modules/handlebars/dist/cjs/handlebars.js"); //Preparo template Handlebars


  var source = $("#disc-template").html(); //Preparo template con funzione
  ...
  function getDiscs() {
    //Funzione che crea tutte le cards
    $.ajax({
      'url': 'dischi.php',
      'method': 'GET',
  ...
  function printDisc(discs) {
    //funzione che stampa dischi
    for (var i = 0; i < discs.length; i++) {
      ...
      var printTemplate = {
        ...
        sImg: discs[i].poster,
        //Immagine canzone
        sTitle: discs[i].title,
        //Titolo canzone
        sAuthor: discs[i].author,
        //Autore canzone
        sGen: discs[i].genre.toLowerCase(),
        //Genere canzone
  ...
  function printSelect(discs) {
    var genrs = [];

    for (var i = 0; i < discs.length; i++) {
      //For per scorrere tutti i dischi
      var getGen = discs[i].genre.toLowerCase(); //Genere canzone per value

      if (!genrs.includes(getGen)) {
        genrs.push(getGen);
      }
    }

    for (var i = 0; i < genrs.length; i++) {
      $("#gen-sel").append('<option value="' + genrs[i] + '">' + genrs[i] + '</option>');
    }
  }
});
...
__webpack_require__(/*! D:\MAMP\htdocs\booleanphp\4Dischi\vAjax\src\js\app.js */"./src/js/app.js");
module.exports = __webpack_require__(/*! D:\MAMP\htdocs\booleanphp\4Dischi\vAjax\src\scss\app.scss */"./src/scss/app.scss");
